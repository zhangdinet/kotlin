...
internal class TypeParcelerParcelSerializer(
    ...
    private val descriptor = parcelerType.constructor.declarationDescriptor as? ClassDescriptor
                             ?: error("Can't find declaration for $parcelerType")
