 ...
 */
@SinceKotlin("1.2")
public header fun Double.toBits(): Long
 ...
 */
@SinceKotlin("1.2")
public header fun Double.toRawBits(): Long

/**
 * Returns the [Double] value corresponding to a given bit representation.
 */
@SinceKotlin("1.2")
public header fun Double.Companion.fromBits(bits: Long): Double
 ...
 */
@SinceKotlin("1.2")
public header fun Float.toBits(): Int
 ...
 */
@SinceKotlin("1.2")
public header fun Float.toRawBits(): Int

/**
 * Returns the [Float] value corresponding to a given bit representation.
 */
@SinceKotlin("1.2")
public header fun Float.Companion.fromBits(bits: Int): Float
