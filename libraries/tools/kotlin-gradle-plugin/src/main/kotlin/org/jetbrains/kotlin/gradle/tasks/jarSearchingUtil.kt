...
private val KOTLIN_JV_SCRIPT_COMPILER_EXPECTED_CLASS = "kotlin.script.experimental.jvm.JvmScriptCompiler"
...
internal fun findKotlinScriptJvmClasspath(project: Project): List<File> =
    findKotlinModuleJar(project, KOTLIN_JV_SCRIPT_COMPILER_EXPECTED_CLASS, KOTLIN_SCRIPT_JVM)
