...
import org.jetbrains.kotlin.idea.caches.project.getScriptDependentModuleInfo
...
class BundledKotlinScriptDependenciesResolver(private val project: Project) : DependenciesResolver {
    ...
    private fun getScriptSDK(project: Project, virtualFile: VirtualFile?): String? {
        if (virtualFile != null) {
            val dependentModuleSourceInfo = getScriptDependentModuleInfo(project, virtualFile)
