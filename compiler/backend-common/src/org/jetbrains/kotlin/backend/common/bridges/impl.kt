...
fun <Signature> generateBridgesForFunctionDescriptor(
    ...
    return generateBridges(DescriptorBasedFunctionHandle(descriptor, isDeclarationAndDefinitionSame), { signature(it.descriptor) })
}
...
class DescriptorBasedFunctionHandle(
    ...
    For non-@JvmDefault target function body is generated in a separate place (DefaultImpls) and
    ...
    */
    ...
    override val isAbstract: Boolean = descriptor.modality == Modality.ABSTRACT || !isDeclarationAndDefinitionSame(descriptor)
