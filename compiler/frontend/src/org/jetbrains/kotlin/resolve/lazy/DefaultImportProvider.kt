...
class DefaultImportProvider(
    ...
    val defaultLowPriorityImports: List<ImportPath> by storageManager.createLazyValue {
        targetPlatform.getDefaultLowPriorityImports()
    }
    ...
    val allDefaultImports: List<ImportPath> by storageManager.createLazyValue {
        defaultImports + defaultLowPriorityImports
    }

    val excludedImports: List<FqName> by storageManager.createLazyValue {
        targetPlatform.excludedImports
    }
}
