...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(INLINE_SUSPEND_FUNCTION_TYPE_UNSUPPORTED, "Inline lambda parameters of suspend function type are not fully supported. Add 'noinline' or 'crossinline' modifier.");
