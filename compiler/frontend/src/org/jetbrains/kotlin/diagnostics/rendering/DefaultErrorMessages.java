...
public class DefaultErrorMessages {
    ...
    static {
        ...
        String checkYourModuleClasspath = "Check your module classpath for missing or conflicting dependencies";
        MAP.put(MISSING_DEPENDENCY_CLASS, "Cannot access class ''{0}''. " + checkYourModuleClasspath, TO_STRING);
        MAP.put(MISSING_DEPENDENCY_SUPERCLASS, "Cannot access superclass ''{0}'' of class ''{1}''. " + checkYourModuleClasspath, TO_STRING, TO_STRING);
