...
class GarbageCollectionMeasurement(val garbageCollectionKind: String, val milliseconds: Long) : PerformanceMeasurement {
    override fun render(): String = "GC time for $garbageCollectionKind is $milliseconds ms"
}


class PerformanceCounterMeasurement(val counterReport: String) : PerformanceMeasurement {
