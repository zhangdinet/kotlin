...
object TopDownAnalyzerFacadeForJVM {
    ...
    fun analyzeFilesWithJavaIntegration(
        ...
        val container = createContainer(
                project, files, trace, configuration, packagePartProvider, declarationProviderFactory,
    ...
    fun createContainer(
        ...
        val dependencyModule = if (separateModules) {
            ...
            val dependenciesContainer = createContainerForTopDownAnalyzerForJvm(
                    ...
                    packagePartProvider(dependencyScope), moduleClassResolver, targetEnvironment, jvmTarget,
                    languageVersionSettings, configureJavaClassFinder
            )
