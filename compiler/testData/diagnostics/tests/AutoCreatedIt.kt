...
fun text() {
    ...
    bar <!TYPE_MISMATCH!><!EXPECTED_PARAMETERS_NUMBER_MISMATCH!>{<!><!TYPE_MISMATCH, TYPE_MISMATCH!><!UNRESOLVED_REFERENCE!>it<!> <!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>+<!> 1<!>}<!>
    ...
    bar2 <!TYPE_MISMATCH!>{it -> <!TYPE_MISMATCH, TYPE_MISMATCH!>it<!>}<!>
}
