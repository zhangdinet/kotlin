...
class SamWrapperTransformationInfo(override val oldClassName: String, private val inliningContext: InliningContext): TransformationInfo {
    ...
    override fun shouldRegenerate(sameModule: Boolean) = !sameModule
