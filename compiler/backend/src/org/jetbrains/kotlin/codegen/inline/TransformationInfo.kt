...
interface TransformationInfo {
    ...
    fun createTransformer(inliningContext: InliningContext, sameModule: Boolean, keepClassBuilder: Boolean): ObjectTransformer<*>
}
...
class WhenMappingTransformationInfo(
    ...
    override fun createTransformer(inliningContext: InliningContext, sameModule: Boolean, keepClassBuilder: Boolean): ObjectTransformer<*> =
...
class AnonymousObjectTransformationInfo internal constructor(
    ...
    override fun createTransformer(inliningContext: InliningContext, sameModule: Boolean, keepClassBuilder: Boolean): ObjectTransformer<*> =
        AnonymousObjectTransformer(this, inliningContext, sameModule, keepClassBuilder)
}
