...
//
//    override fun <T : Any?> putUserData(key: Key<T>, value: T?) = classOrObject.putUserData(key, value).also {
//        if (addedKeys.add(key))
//            println("putUserData $key")
//    }
//
//    override fun <T : Any?> getUserData(key: Key<T>): T? = classOrObject.getUserData(key)
//
//    override fun <T : Any?> putUserDataIfAbsent(key: Key<T>, value: T): T = classOrObject.putUserDataIfAbsent(key, value).also {
//        if (addedKeys.add(key))
//            println("putUserData $key")
//    }
//
...
private val addedKeys = Collections.synchronizedSet(mutableSetOf<Key<*>>())
